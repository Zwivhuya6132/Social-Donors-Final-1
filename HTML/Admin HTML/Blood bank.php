...
<head>
    ...
    <title>Social Donors Blood Bank</title>
    ...
    <link rel="stylesheet" href="../../Stylesheets/Admin CSS/Blood bank.css">
</head>
    ...
    <header class="header">
        ...
        <div class="container">
            ...
            <ul class="header-navigation-anchor">
                ...
                <a href="Blood bank.php"><li class="actv">Blood Bank</li></a>
...
<main>
    ...
    <section class="section-two">
        ...
        <div class="map">
            ...
            <h1 class="ss">Where To Find Us</h1>
