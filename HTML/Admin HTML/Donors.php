...
<head>
    ...
    <title>Social Donors - Donors</title>
    ...
    <link rel="stylesheet" href="../../Stylesheets/Admin CSS/Donors.css">
</head>
    ...
    <header class="header">
        ...
        <div class="container">
            ...
            <ul class="header-navigation-anchor">
                ...
                <a href="donors.php"><li class="actv">Donors</li></a>
...
<main>
    ...
    <table>
        ...
        <h1 class="table-heading">DONORS</h1>

        <th>DONOR NAMES</th>
        <th>LAST DONATED</th>
        <th>EMEGENCY NUMBER</th>
        <th>BLOOD GROUP</th>

        <tr>
            <td class="td">
                <img src="../../Profile Pictures/Ellipse 4.png" alt="">
                Steve Borden
            </td>
            <td class="td">
                <img src="../../Icons/bx_time.png" alt="">
                08 June 2022
                </td>
            <td>+27 356 642 091</td>
            <td>AB</td>
        </tr>

        <tr>
            <td class="td">
                <img src="../../Profile Pictures/Ellipse 5.png" alt="">
                John Cena
            </td>
            <td class="td">
                <img src="../../Icons/bx_time.png" alt="">
                08 June 2022</td>
            <td>+27 978 622 983</td>
            <td>A+</td>
        </tr>

        <tr>
            <td class="td">
                <img src="../../Profile Pictures/Ellipse 6.png" alt="">
                Eddie Guerrerro</td>
            <td class="td">
                <img src="../../Icons/bx_time.png" alt="">
                08 June 2022</td>
            <td>+27 935 636 669</td>
            <td>O-</td>
        </tr>

        <tr>
            <td class="td">
                <img src="../../Profile Pictures/Ellipse 7.png" alt="">
                Lucifer Morningstar</td>
            <td class="td">
                <img src="../../Icons/bx_time.png" alt="">
                08 June 2022</td>
            <td>+27 455 992 002</td>
            <td>A+</td>
        </tr>

        <tr>
            <td class="td">
                <img class="zwivhuya" src="../../Profile Pictures/_CPM7303.jpg" alt="">
                Bob Marley</td>
            <td class="td">
                <img src="../../Icons/bx_time.png" alt="">
                19 June 2022</td>
